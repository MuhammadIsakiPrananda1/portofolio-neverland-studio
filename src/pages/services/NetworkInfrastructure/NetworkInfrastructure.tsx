      ...
      <div className="container-custom">
        ...
        >
          ...
          <div className="inline-flex p-4 rounded-sm border border-sky-500/30 bg-sky-500/10 mb-6">
            <Network className="w-12 h-12 text-sky-500" />
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="rounded-sm p-5 text-center border border-white/5 bg-[#0B1120] hover:border-sky-500/30 transition-colors duration-300">
                ...
                <p className="text-slate-500 font-mono text-xs">Network experts</p>
              </div>
              <div className="rounded-sm p-5 text-center border border-white/5 bg-[#0B1120] hover:border-sky-500/30 transition-colors duration-300">
              ...
              <div className="rounded-sm p-5 text-center border border-white/5 bg-[#0B1120] hover:border-sky-500/30 transition-colors duration-300">
                <Network className="w-10 h-10 text-sky-500 mx-auto mb-3" />
                <h4 className="text-lg font-black uppercase tracking-tight text-white mb-1">99.99% Uptime</h4>
                <p className="text-slate-500 font-mono text-xs">Guaranteed SLA</p>
              </div>
              <div className="rounded-sm p-5 text-center border border-white/5 bg-[#0B1120] hover:border-sky-500/30 transition-colors duration-300">
                <TrendingUp className="w-10 h-10 text-sky-500 mx-auto mb-3" />
                <h4 className="text-lg font-black uppercase tracking-tight text-white mb-1">50+ Networks</h4>
        ...
        {/* ─── Network Infrastructure Certification Roadmap ─── */}
        <motion.div className="mb-20" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
          <SectionTitle subtitle="Career Path" title="Network Infrastructure Certification Roadmap" className="mb-4" />
          <p className="text-center text-gray-400 text-sm mb-12 max-w-2xl mx-auto">
            From network basics to enterprise network architect — certifications for networking professionals.
          </p>
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 mb-10">
            {[{ label: 'Cisco', color: 'bg-blue-500' }, { label: 'Security', color: 'bg-red-500' }, { label: 'Cloud Networking', color: 'bg-amber-500' }, { label: 'SD-WAN / Advanced', color: 'bg-purple-500' }].map(t => (
          ...
          {[
            { level: 'Beginner', levelColor: 'from-sky-500 to-cyan-400', levelBorder: 'border-sky-500/30', levelBg: 'bg-sky-500/10', levelText: 'text-sky-300', desc: 'Networking fundamentals and entry-level certifications.',
              certs: [
                { name: 'CompTIA Net+',  org: 'CompTIA',  track: 'cisco',   desc: 'CompTIA Network+ — vendor-neutral networking fundamentals.' },
                { name: 'Cisco CCST',    org: 'Cisco',    track: 'cisco',   desc: 'Cisco Certified Support Technician — entry Cisco networking.' },
                { name: 'CompTIA Sec+',  org: 'CompTIA',  track: 'security', desc: 'Security+ — basic network security concepts and hardening.' },
                { name: 'AWS CLF-C02',  org: 'Amazon',   track: 'cloud',   desc: 'Cloud Practitioner — understand cloud networking basics.' },
              ]},
            { level: 'Intermediate', levelColor: 'from-amber-500 to-yellow-400', levelBorder: 'border-amber-500/30', levelBg: 'bg-amber-500/10', levelText: 'text-amber-300', desc: 'Cisco enterprise networking and cloud network design.',
              certs: [
                { name: 'CCNA',          org: 'Cisco',    track: 'cisco',   desc: 'Cisco Certified Network Associate — routing, switching, OSPF, EIGRP.' },
                { name: 'AWS ANS-C01',   org: 'Amazon',   track: 'cloud',   desc: 'Advanced Networking Specialty — VPC, Direct Connect, Transit Gateway.' },
                { name: 'Juniper JNCIA', org: 'Juniper',  track: 'cisco',   desc: 'JNCIA-Junos — Juniper networking fundamentals and JunOS routing.' },
                { name: 'CompTIA CySA+', org: 'CompTIA',  track: 'security', desc: 'CySA+ — network threat detection and security operations.' },
              ]},
            { level: 'Advanced', levelColor: 'from-orange-500 to-amber-500', levelBorder: 'border-orange-500/30', levelBg: 'bg-orange-500/10', levelText: 'text-orange-300', desc: 'Advanced enterprise networking, SD-WAN, and hybrid cloud.',
              certs: [
                { name: 'CCNP Enterprise',org: 'Cisco',   track: 'cisco',   desc: 'CCNP — enterprise routing, switching, SD-WAN, and automation.' },
                { name: 'CCNP Security',  org: 'Cisco',   track: 'security', desc: 'CCNP Security — Cisco security platforms and network protection.' },
                { name: 'Azure Net. Eng',org: 'Microsoft',track: 'cloud',   desc: 'AZ-700 — Azure hybrid networks and private connectivity.' },
                { name: 'VMware NSX',    org: 'VMware',   track: 'advanced', desc: 'NSX-T Foundation — software-defined networking for enterprise.' },
              ]},
            { level: 'Expert', levelColor: 'from-rose-500 to-pink-500', levelBorder: 'border-rose-500/30', levelBg: 'bg-rose-500/10', levelText: 'text-rose-300', desc: 'Expert-level network architect and network security leader.',
              certs: [
                { name: 'CCIE Enterprise',org: 'Cisco',   track: 'cisco',   desc: 'CCIE Enterprise Infrastructure — top-tier Cisco expert certification.' },
                { name: 'CCIE Security', org: 'Cisco',    track: 'security', desc: 'CCIE Security — expert-level network security architecture.' },
                { name: 'VMware VCIX-NV',org: 'VMware',   track: 'advanced', desc: 'NSX Expert — SDN architecture and micro-segmentation design.' },
                { name: 'CISSP',          org: 'ISC²',    track: 'security', desc: 'CISSP — gold-standard for senior network security professionals.' },
              ]},
          ].map((row, rowIdx, arr) => {
            const ts: Record<string, { bg: string; border: string; text: string; dot: string }> = {
              cisco:    { bg: 'bg-blue-500/10',   border: 'border-blue-500/25',   text: 'text-blue-300',   dot: 'bg-blue-500' },
              ...
              advanced: { bg: 'bg-purple-500/10', border: 'border-purple-500/25', text: 'text-purple-300', dot: 'bg-purple-500' },
            };
        ...
        >
          ...
          <div className="space-y-8">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-sm border border-sky-500/30 bg-sky-500/10">
              ...
              <span className="text-xs font-semibold text-sky-400 uppercase tracking-widest">Network Infrastructure</span>
            </div>
            ...
            <div className="space-y-4">
              <h2 className="text-4xl lg:text-5xl font-black uppercase tracking-tight">
                ...
                <br />
                <span className="text-sky-500">Network Infrastructure</span>
              </h2>
