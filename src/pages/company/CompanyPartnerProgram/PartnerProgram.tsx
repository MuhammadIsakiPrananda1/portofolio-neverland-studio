...
import { Handshake, Star, Shield, Zap, TrendingUp, CheckCircle, ArrowRight, Award, Users, Globe, Rocket, BarChart3 } from 'lucide-react';
...
const PartnerProgram = () => {
    ...
    const steps = [
        { step: '01', title: 'Apply Online', desc: 'Submit your application via email or our partner portal.' },
        { step: '02', title: 'Onboarding Call', desc: 'A dedicated manager will walk you through the program details.' },
        { step: '03', title: 'Get Certified', desc: 'Complete our training tracks to unlock full partner benefits.' },
        { step: '04', title: 'Start Winning', desc: 'Register deals, access resources, and grow your revenue.' },
    ];
