...
export default function Home() {
  ...
  return (
    <div className="relative">
      {/* Decorative Background Elements — desktop only (expensive blur paint on mobile) */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none hidden sm:block">
        <div className="absolute top-0 right-0 w-[400px] h-[400px] lg:w-[500px] lg:h-[500px] bg-purple-500/10 rounded-full blur-[120px]" />
        <div className="absolute bottom-0 left-0 w-[350px] h-[350px] lg:w-[400px] lg:h-[400px] bg-blue-500/10 rounded-full blur-[100px]" />
      </div>
