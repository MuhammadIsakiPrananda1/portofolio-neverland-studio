      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="flex items-center justify-center mb-4">
            <Cpu className="w-12 h-12 text-red-500 mr-4 drop-shadow-[0_0_10px_rgba(239,68,68,0.3)]" />
            <h1 className="text-4xl md:text-5xl font-black text-white uppercase tracking-tight">
              Binary Exploitation <span className="text-red-500 drop-shadow-[0_0_10px_rgba(239,68,68,0.3)]">Playground</span>
            </h1>
          </div>
