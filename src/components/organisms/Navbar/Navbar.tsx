  ...
  return (
    <>
      ...
      <button
        ...
        className={`lg:hidden fixed top-6 z-[60] p-3 rounded-sm bg-[#0B1120] border border-white/10 hover:border-red-500/30 hover:bg-white/5 transition-all duration-300 shadow-lg ${
          isOpen ? "left-[264px]" : "left-6"
        }`}
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.aside
            className="lg:hidden fixed left-0 top-0 h-[100dvh] w-80 bg-[#0B1120] border-r border-white/10 z-50 flex flex-col shadow-2xl overflow-hidden"
            initial={{ x: "-100%" }}
            animate={{ x: 0 }}
            exit={{ x: "-100%" }}
